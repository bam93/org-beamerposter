...
\begin{frame}[label={sec:orgafbee0e}]{}
\begin{columns}
...
\caption{\label{fig:orgfa89bca}Interactive Molecular Simulation and Analysis examples.}
\end{figure}
\end{alertblock}
...
\caption{\label{fig:org9873f08}An overview of MolPlay's architecture.}
\end{figure}
...
\caption{\label{fig:orga512497}Task categories for interactive approaches.}
\end{figure}
\end{block}
\end{column}
...
\caption{\label{fig:orge87612f}Four use cases for interactive simulations.}
\end{figure}
...
\caption{\label{fig:orgd8486cf}MolPlay's user interface is simple and user friendly.}
\end{figure}
...
\caption{\label{fig:orgfac5b5d}Visual analysis of statistical molecular interaction fields \autocites{smifferurl}[][]{smifferpreprint}.}
\end{figure}
